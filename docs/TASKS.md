...
> **Progresso:** **M1–M3** `[x]`. **Local:** **M4–M15** `[%]`. **Pivot jul/2026:** app Expo = **WebView do site F28** (`mobile/App.tsx` → URL cloud) — visual/dados idênticos ao mobile web; telas nativas arquivadas. Ver `mobile/docs/WEBVIEW.md`.
