...
> **Progresso:** Bloco 1 ✅ · **Bloco 2a/2b** ✅ · **Bloco 6a** — **PLAN** ✅ · **B39–B43** `[x]` · próximo **O1**.
...
| **#4** | 6a | Supabase + deploy global | **O1** *(deploy Cloudflare)* | 5/8 |
...
11. **Próximo passo:** **O1** (deploy Cloudflare + cron ping Supabase) — **B39–B43** ✅ · backend Postgres validado localmente.
