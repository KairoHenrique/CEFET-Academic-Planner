...
> **Próximo oficial:** **#7 — PIX** — **B48** gateway *(B47 ✅)*.
...
> **Progresso:** Bloco 1 ✅ · **Bloco 2a/2b** ✅ · **Bloco 6a** ✅ **8/8** · **6b** ✅ **8/8** · **6c** ✅ **2/2** · **#6d** ✅ **6/6** · **#6e** ✅ **2/2** · **#7** **1/15** (B47 ✅) · URL **`https://acme-hub.khfm.workers.dev`**.
...
| **#7** | 7 | Assinatura PIX | **B48** em seguida | 1/15 |
...
- Stub em `build-subscription-dev.ts` → labels/durações via **`app/src/lib/billing/`** (**B47** ✅); `/planos` consome catálogo + `GET /api/billing/plans`; checkout PIX evolui em **B48–B50**; resgate chave quando **B69** existir.
...
11. **Próximo passo:** **#7 — PIX** — **B48** gateway *(B47 ✅)*.
