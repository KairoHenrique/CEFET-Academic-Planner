...
> **Próximo oficial:** **T1** (smoke deploy). Ver [`docs/plan/o2-prod-postgres.md`](./plan/o2-prod-postgres.md).
...
> **Progresso:** Bloco 1 ✅ · **Bloco 2a/2b** ✅ · **Bloco 6a** — **PLAN** ✅ · **B39–B43** `[x]` · **O1** `[@]` · **O2** `[%]` · próximo **T1**.
...
| **#4** | 6a | Supabase + deploy global | **T1** *(smoke deploy)* | 5/8 |
...
> **Próximo:** **T1** — smoke deploy (URL abre, health, PPC).
...
11. **Próximo passo:** **T1** (smoke deploy) — **O2** `[%]` commit local · **O1** `[@]` no remoto.
