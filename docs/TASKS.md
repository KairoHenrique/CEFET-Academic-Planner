...
**Próximo:** **#10 — Bloco 4** (Polimento UX + site mobile, F28). **B36/B37** `[x]` (sino) · **F24 descartado**. Bloco **2f/B72** e **B35/F20** `[x]` (push jul/2026).
...
> **Próximo (produto):** **#10 — Bloco 4** (Polimento UX + site mobile, F28). **B36/B37** `[x]` (sino) · **F24 descartado**. Bloco **2f/B72** e **F20** `[x]` (push jul/2026).
...
11. **Próximo passo:** **#10 — Bloco 4** (Polimento UX + site mobile, F28). **#9 fechado:** **B36/B37** `[x]` (alertas no sino, aprovado jul/2026) · **F24 descartado** (banners removidos — só sino) · demais `[x]`. Ops sync = PC home server (`npm run worker:home` + `npm run worker:tunnel` + secrets CF; dev scraper `SIGAA_BROWSER_CHANNEL=chrome`).
