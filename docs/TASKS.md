...
> **Próximo oficial:** **#7 — PIX** — **B48** gateway *(B47 `[@]` no remoto)*.
...
- [@] **PLAN:** B47 *(planos e preços — trial + 3m/6m/12m/5a; R$ 50/85/150/700; trial 7d 1×/CPF)*
...
> **Progresso:** Bloco 1 ✅ · **Bloco 2a/2b** ✅ · **Bloco 6a** ✅ **8/8** · **6b** ✅ **8/8** · **6c** ✅ **2/2** · **#6d** ✅ **6/6** · **#6e** ✅ **2/2** · **#7** **B47** `[@]` · URL **`https://acme-hub.khfm.workers.dev`**.
...
| # | Tipo | Task | Resumo | Status |
|---|------|------|--------|--------|
| B47 | Plan | Planos e preços | Trial + 3m/6m/12m/5a — **R$ 50 / 85 / 150 / 700**; trial 7d 1×/CPF | [@] |
...
- [ ] Chaves gift / promoções — **B69/F40** (placeholder no painel)
...
- Stub em `build-subscription-dev.ts` → labels/durações via **`app/src/lib/billing/`** (**B47** catálogo); `/planos` consome catálogo + `GET /api/billing/plans`; checkout PIX evolui em **B48–B50**; resgate chave quando **B69** existir.
...
11. **Próximo passo:** **#7 — PIX** — **B48** gateway *(B47 `[@]` no remoto)*.
