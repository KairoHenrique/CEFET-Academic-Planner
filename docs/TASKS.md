...
> **Próximo oficial:** **O1** (deploy Cloudflare + cron ping) — após **B41–B43** `[%]`. Ver [`docs/plan/6a-supabase-plan.md`](./plan/6a-supabase-plan.md).
...
> **Progresso:** Bloco 1 ✅ · **Bloco 2a/2b** ✅ · **Bloco 6a** — **PLAN** ✅ · **B39–B43** `[%]` · próximo **O1**.
...
11. **Próximo passo:** **O1** (deploy Cloudflare) — **B41–B43** em `[%]` commit local.
