 ...
 *   $env:SIGAA_HISTORICO_PDF_PATH="..\docs\referencias\historico_20243003554.pdf"
 *   npx tsx scripts/backfill-historico-from-pdf.ts 15224845661
 */
...
async function main(): Promise<void> {
  ...
  const pdfPath =
    ...
    "../docs/referencias/historico_20243003554.pdf";
